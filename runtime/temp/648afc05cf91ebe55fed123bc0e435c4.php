<?php /*a:2:{s:63:"E:\xampp\htdocs\rhaphp\themes/pc/extension/gongzicha\index.html";i:1587519919;s:68:"E:\xampp\htdocs\rhaphp\themes/pc/extension/..\admin\common\base.html";i:1587532401;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <tbody>
                ...
                <tr data-index="0">
                    ...
                    <td data-field="username" data-key="1-0-1" class="">
                        <div class="layui-table-cell laytable-cell-1-0-1"><?php echo htmlentities($vo['realname']); ?></div>
                    </td>
                    <td data-field="sex" data-key="1-0-2" class="">
                        <div class="layui-table-cell laytable-cell-1-0-2"><?php echo htmlentities($vo['idcard']); ?></div>
                    </td>
                    <td data-field="sign" data-key="1-0-4" class="">
                        <div class="layui-table-cell laytable-cell-1-0-4"><?php echo htmlentities($vo['salary_final']); ?></div>
                    </td>
...
<script>
    ...
    //         location.href = "<?php echo url('update'); ?>";
    //     });
    // })
        ...
        var uploadInst = upload.render({
            ...
            ,done: function(res){
                ...
                　　});
                    ...
                    location.href = "<?php echo url('preview'); ?>?excel_id="+res.excel_id;
                }
            }
            ,error: function(){
              //请求异常回调
    ...
    //     layui.use('layer',function () {
    //         layer = layui.layer;
    //         tips = layer.tips("<img src='/public/static/images/example.jpg' style='width:300px;position:realtion' alt=''>", '#update', {
    //           tips: [1, '#00f']
    //         })
    //     })
    // },function(){
